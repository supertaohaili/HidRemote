...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        backgroundBorderColor = optColor(typedArray,
                R.styleable.SwitchButton_sb_background_border_color,
                0XffDDDDDD);//Color.WHITE;
    ...
    private void drawButton(Canvas canvas, float x, float y) {
        ...
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(1);
        paint.setColor(backgroundBorderColor);
