package www.bigkoo.pickerview.configure;
...
import www.bigkoo.pickerview.listener.CustomListener;
import www.bigkoo.pickerview.listener.OnOptionsSelectChangeListener;
import www.bigkoo.pickerview.listener.OnOptionsSelectListener;
import www.bigkoo.pickerview.listener.OnTimeSelectChangeListener;
import www.bigkoo.pickerview.listener.OnTimeSelectListener;
import www.contrarywind.view.WheelView;
...
public class PickerOptions {
    ...
    public int textSizeSubmitCancel = 12;//确定取消按钮大小
    public int textSizeTitle = 13;//标题文字大小
